...
This repo contains the implementation of the model proposed in `SSCI: self-supervised deep learning improves networkstructure for cancer driver gene identification`
